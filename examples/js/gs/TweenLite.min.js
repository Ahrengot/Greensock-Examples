...
this._uncache(!0));return this};d.render=function(a,c){var b=this._first,d;for(this._totalTime=this._time=this._rawPrevTime=a;b;){d=b._next;if(b._active||a>=b._startTime&&!b._paused)b._reversed?b.render((!b._dirty?b._totalDuration:b.totalDuration())-(a-b._startTime)*b._timeScale,c,!1):b.render((a-b._startTime)*b._timeScale,c,!1);b=d}};d.rawTime=function(){return this._totalTime};var h=r("TweenLite",function(a,c,b){q.call(this,c,b);if(null==a)throw"Cannot tween an undefined reference.";this.target=
a;this._overwrite=null==this.vars.overwrite?L[h.defaultOverwrite]:"number"===typeof this.vars.overwrite?this.vars.overwrite>>0:L[this.vars.overwrite];if((a instanceof Array||a.jquery)&&"object"===typeof a[0]){this._targets=a.slice(0);this._propLookup=[];this._siblings=[];for(a=0;a<this._targets.length;a++)b=this._targets[a],b.jquery?(this._targets.splice(a--,1),this._targets=this._targets.concat(b.constructor.makeArray(b))):(this._siblings[a]=z(b,this,!1),1===this._overwrite&&1<this._siblings[a].length&&
F(b,this,null,1,this._siblings[a]))}else this._propLookup={},this._siblings=z(a,this,!1),1===this._overwrite&&1<this._siblings.length&&F(a,this,null,1,this._siblings);(this.vars.immediateRender||0===c&&0===this._delay&&!1!==this.vars.immediateRender)&&this.render(-this._delay,!1,!0)},!0);d=h.prototype=new q;d.constructor=h;d.kill()._gc=!1;d.ratio=0;d._firstPT=d._targets=d._overwrittenProps=null;d._notifyPluginsOfEnabled=!1;h.version=1.63;h.defaultEase=d._ease=new t(null,null,1,1);h.defaultOverwrite=
...
c,b){var d=a._gsTweenID,e;if(!v[d||(a._gsTweenID=d="t"+O++)])v[d]={target:a,tweens:[]};if(c&&(a=v[d].tweens,a[e=a.length]=c,b))for(;-1<--e;)a[e]===c&&a.splice(e,1);return v[d].tweens},F=function(a,c,b,d,e){var g,i,f;if(1===d||4<=d){a=e.length;for(g=0;g<a;g++)if((f=e[g])!==c)f._gc||f._enabled(!1,!1)&&(i=!0);else if(5===d)break;return i}var h=c._startTime+1E-10,n=[],j=0,l=0===c._duration,m;for(g=e.length;-1<--g;)if(!((f=e[g])===c||f._gc||f._paused))f._timeline!==c._timeline?(m=m||N(c,0,l),0===N(f,m,
l)&&(n[j++]=f)):f._startTime<=h&&f._startTime+f.totalDuration()/f._timeScale+1E-10>h&&((l||!f._initted)&&2E-10>=h-f._startTime||(n[j++]=f));for(g=j;-1<--g;)if(f=n[g],2===d&&f._kill(b,a)&&(i=!0),2!==d||!f._firstPT&&f._initted)f._enabled(!1,!1)&&(i=!0);return i},N=function(a,c,b){for(var d=a._timeline,e=d._timeScale,g=a._startTime;d._timeline;){g+=d._startTime;e*=d._timeScale;if(d._paused)return-100;d=d._timeline}g/=e;return g>c?g-c:b&&g===c||!a._initted&&2E-10>g-c?1E-10:(g+=a.totalDuration()/a._timeScale/
e)>c?0:g-c-1E-10};d._init=function(){this.vars.startAt&&(this.vars.startAt.overwrite=0,this.vars.startAt.immediateRender=!0,h.to(this.target,0,this.vars.startAt));var a,c;this._ease=this.vars.ease instanceof t?this.vars.easeParams instanceof Array?this.vars.ease.config.apply(this.vars.ease,this.vars.easeParams):this.vars.ease:"function"===typeof this.vars.ease?new t(this.vars.ease,this.vars.easeParams):h.defaultEase;this._easeType=this._ease._type;this._easePower=this._ease._power;this._firstPT=null;
if(this._targets)for(a=this._targets.length;-1<--a;){if(this._initProps(this._targets[a],this._propLookup[a]={},this._siblings[a],this._overwrittenProps?this._overwrittenProps[a]:null))c=!0}else c=this._initProps(this.target,this._propLookup,this._siblings,this._overwrittenProps);c&&h._onPluginEvent("_onInitAllProps",this);this._overwrittenProps&&null==this._firstPT&&"function"!==typeof this.target&&this._enabled(!1,!1);if(this.vars.runBackwards)for(a=this._firstPT;a;)a.s+=a.c,a.c=-a.c,a=a._next;
this._onUpdate=this.vars.onUpdate;this._initted=!0};d._initProps=function(a,c,b,d){var e,g,i,f,h,j;if(null==a)return!1;for(e in this.vars){if(P[e]){if("onStartParams"===e||"onUpdateParams"===e||"onCompleteParams"===e||"onReverseCompleteParams"===e||"onRepeatParams"===e)if(h=this.vars[e])for(g=h.length;-1<--g;)"{self}"===h[g]&&(h=this.vars[e]=h.concat(),h[g]=this)}else if(M[e]&&(f=new M[e])._onInitTween(a,this.vars[e],this)){this._firstPT=j={_next:this._firstPT,t:f,p:"setRatio",s:0,c:1,f:!0,n:e,pg:!0,
pr:f._priority};for(g=f._overwriteProps.length;-1<--g;)c[f._overwriteProps[g]]=this._firstPT;if(f._priority||f._onInitAllProps)i=!0;if(f._onDisable||f._onEnable)this._notifyPluginsOfEnabled=!0}else this._firstPT=c[e]=j={_next:this._firstPT,t:a,p:e,f:"function"===typeof a[e],n:e,pg:!1,pr:0},j.s=!j.f?parseFloat(a[e]):a[e.indexOf("set")||"function"!==typeof a["get"+e.substr(3)]?e:"get"+e.substr(3)](),g=this.vars[e],j.c="number"===typeof g?g-j.s:"string"===typeof g&&"="===g.charAt(1)?parseInt(g.charAt(0)+
"1")*Number(g.substr(2)):Number(g)||0;j&&j._next&&(j._next._prev=j)}return d&&this._kill(d,a)?this._initProps(a,c,b,d):1<this._overwrite&&this._firstPT&&1<b.length&&F(a,this,c,this._overwrite,b)?(this._kill(c,a),this._initProps(a,c,b,d)):i};d.render=function(a,c,b){var d=this._time,e,g;if(a>=this._duration){if(this._totalTime=this._time=this._duration,this.ratio=this._ease._calcEnd?this._ease.getRatio(1):1,this._reversed||(e=!0,g="onComplete"),0===this._duration){if(0===a||0>this._rawPrevTime)this._rawPrevTime!==
a&&(b=!0);this._rawPrevTime=a}}else if(0>=a){this._totalTime=this._time=0;this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0;if(0!==d||0===this._duration&&0<this._rawPrevTime)g="onReverseComplete",e=this._reversed;0>a?(this._active=!1,0===this._duration&&(0<=this._rawPrevTime&&(b=!0),this._rawPrevTime=a)):this._initted||(b=!0)}else if(this._totalTime=this._time=a,this._easeType){var i=a/this._duration,f=this._easeType,h=this._easePower;if(1===f||3===f&&0.5<=i)i=1-i;3===f&&(i*=2);1===h?i*=i:2===
h?i*=i*i:3===h?i*=i*i*i:4===h&&(i*=i*i*i*i);this.ratio=1===f?1-i:2===f?i:0.5>a/this._duration?i/2:1-i/2}else this.ratio=this._ease.getRatio(a/this._duration);if(this._time!==d||b){this._initted||(this._init(),!e&&this._time&&(this.ratio=this._ease.getRatio(this._time/this._duration)));!this._active&&!this._paused&&(this._active=!0);if(0===d&&this.vars.onStart&&(0!==this._time||0===this._duration))c||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||D);for(a=this._firstPT;a;){if(a.f)a.t[a.p](a.c*
this.ratio+a.s);else a.t[a.p]=a.c*this.ratio+a.s;a=a._next}this._onUpdate&&(c||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||D));g&&!this._gc&&(e&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),c||this.vars[g]&&this.vars[g].apply(this.vars[g+"Scope"]||this,this.vars[g+"Params"]||D))}};d._kill=function(a,c){"all"===a&&(a=null);if(null==a&&(null==c||c==this.target))return this._enabled(!1,!1);var c=c||this._targets||this.target,b,d,e,g,h,f,j;
if((c instanceof Array||c.jquery)&&"object"===typeof c[0])for(b=c.length;-1<--b;)this._kill(a,c[b])&&(h=!0);else{if(this._targets)for(b=this._targets.length;-1<--b;){if(c===this._targets[b]){g=this._propLookup[b]||{};this._overwrittenProps=this._overwrittenProps||[];d=this._overwrittenProps[b]=a?this._overwrittenProps[b]||{}:"all";break}}else{if(c!==this.target)return!1;g=this._propLookup;d=this._overwrittenProps=a?this._overwrittenProps||{}:"all"}if(g)for(e in f=a||g,j=a!=d&&"all"!=d&&a!=g&&(null==
a||!0!=a._tempKill),f){if(b=g[e]){b.pg&&b.t._kill(f)&&(h=!0);if(!b.pg||0===b.t._overwriteProps.length)b._prev?b._prev._next=b._next:b===this._firstPT&&(this._firstPT=b._next),b._next&&(b._next._prev=b._prev),b._next=b._prev=null;delete g[e]}j&&(d[e]=1)}}return h};d.invalidate=function(){this._notifyPluginsOfEnabled&&h._onPluginEvent("_onDisable",this);this._onUpdate=this._overwrittenProps=this._firstPT=null;this._initted=this._active=this._notifyPluginsOfEnabled=!1;this._propLookup=this._targets?
{}:[];return this};d._enabled=function(a,c){if(a&&this._gc)if(this._targets)for(var b=this._targets.length;-1<--b;)this._siblings[b]=z(this._targets[b],this,!0);else this._siblings=z(this.target,this,!0);q.prototype._enabled.call(this,a,c);return this._notifyPluginsOfEnabled&&this._firstPT?h._onPluginEvent(a?"_onEnable":"_onDisable",this):!1};h.to=function(a,c,b){return new h(a,c,b)};h.from=function(a,c,b){b.runBackwards=!0;!1!=b.immediateRender&&(b.immediateRender=!0);return new h(a,c,b)};h.fromTo=
function(a,c,b,d){d.startAt=b;b.immediateRender&&(d.immediateRender=!0);return new h(a,c,d)};h.delayedCall=function(a,c,b,d,e){return new h(c,0,{delay:a,onComplete:c,onCompleteParams:b,onCompleteScope:d,onReverseComplete:c,onReverseCompleteParams:b,onReverseCompleteScope:d,immediateRender:!1,useFrames:e,overwrite:0})};h.set=function(a,c){return new h(a,0,c)};h.killTweensOf=h.killDelayedCallsTo=function(a,c){for(var b=h.getTweensOf(a),d=b.length;-1<--d;)b[d]._kill(c,a)};h.getTweensOf=function(a){if(null!=
a){var c,b,d;if((a instanceof Array||a.jquery)&&"object"===typeof a[0]){c=a.length;for(b=[];-1<--c;)b=b.concat(h.getTweensOf(a[c]));for(c=b.length;-1<--c;){d=b[c];for(a=c;-1<--a;)d===b[a]&&b.splice(c,1)}}else{b=z(a).concat();for(c=b.length;-1<--c;)b[c]._gc&&b.splice(c,1)}return b}};var A=r("plugins.TweenPlugin",function(a,c){this._overwriteProps=(a||"").split(",");this._propName=this._overwriteProps[0];this._priority=c||0},!0);d=A.prototype;A.version=12;A.API=2;d._firstPT=null;d._addTween=function(a,
c,b,d,e,g){var h;if(null!=d&&(h="number"===typeof d||"="!==d.charAt(1)?Number(d)-b:parseInt(d.charAt(0)+"1")*Number(d.substr(2))))this._firstPT=a={_next:this._firstPT,t:a,p:c,s:b,c:h,f:"function"===typeof a[c],n:e||c,r:g},a._next&&(a._next._prev=a)};d.setRatio=function(a){for(var c=this._firstPT,b;c;){b=c.c*a+c.s;c.r&&(b=b+(0<b?0.5:-0.5)>>0);if(c.f)c.t[c.p](b);else c.t[c.p]=b;c=c._next}};d._kill=function(a){if(null!=a[this._propName])this._overwriteProps=[];else for(var c=this._overwriteProps.length;-1<
--c;)null!=a[this._overwriteProps[c]]&&this._overwriteProps.splice(c,1);for(c=this._firstPT;c;)null!=a[c.n]&&(c._next&&(c._next._prev=c._prev),c._prev?(c._prev._next=c._next,c._prev=null):this._firstPT===c&&(this._firstPT=c._next)),c=c._next;return!1};d._roundProps=function(a,c){for(var b=this._firstPT;b;){if(a[this._propName]||null!=b.n&&a[b.n.split(this._propName+"_").join("")])b.r=c;b=b._next}};h._onPluginEvent=function(a,c){var b=c._firstPT,d;if("_onInitAllProps"===a){for(var e,g,h,f;b;){f=b._next;
for(e=g;e&&e.pr>b.pr;)e=e._next;(b._prev=e?e._prev:h)?b._prev._next=b:g=b;(b._next=e)?e._prev=b:h=b;b=f}b=c._firstPT=g}for(;b;)b.pg&&"function"===typeof b.t[a]&&b.t[a]()&&(d=!0),b=b._next;return d};A.activate=function(a){for(var c=a.length;-1<--c;)a[c].API===A.API&&(h._plugins[(new a[c])._propName]=a[c]);return!0};if(p=m._gsQueue){for(j=0;j<p.length;j++)p[j]();for(d in w)w[d].def||console.log("Warning: TweenLite encountered missing dependency: com.greensock."+d)}})(window);